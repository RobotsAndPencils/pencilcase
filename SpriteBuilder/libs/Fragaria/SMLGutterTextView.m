...
- (void)drawViewBackgroundInRect:(NSRect)rect
{
    ...
    [imgBreakpoint0 drawInRect:NSMakeRect(2, 110, 4, 12) fromRect:NSZeroRect operation:NSCompositeSourceOver fraction:1 respectFlipped:YES hints:nil];
    [imgBreakpoint2 drawInRect:NSMakeRect(bounds.size.width-11, 110, 8, 12) fromRect:NSZeroRect operation:NSCompositeSourceOver fraction:1 respectFlipped:YES hints:nil];
}*/
