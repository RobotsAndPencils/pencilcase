//
//  PCTableCellInfoPressedStatement.m
//  Behaviours
//
...
#import "PCTableCellInfoPressedStatement.h"
...
@interface PCTableCellInfoPressedStatement ()
...
@implementation PCTableCellInfoPressedStatement

__attribute__((constructor)) static void registerStatement(void) {
    [[PCStatementRegistry sharedInstance] registerWhenStatementClass:[PCTableCellInfoPressedStatement class]];
}
...
- (instancetype)init {
    ...
    if (self) {
        ...
        [self appendString:@"When the info button on table "];
