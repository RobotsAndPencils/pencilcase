...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    PCAppViewController *appViewController = [[PCAppViewController alloc] initWithApp:pencilCaseApp startSlideIndex:[self startSlideIndex]];
...
/**
 By default will use MyProject.creation within the bundle but you can specify another path using launch arguments.
 */
