...
//
//  Created by Paul Thorsteinson on 2014-08-18.
...
/**
 By default will use Sample.creation within the bundle but you can specify another path using launch arguments.
 */
- (NSURL *)pencilCaseAppURL {
    ...
    if ([launchArgumentAppPath length] > 0) {
        ...
        return [[NSBundle mainBundle] URLForResource:@"Sample" withExtension:@"creation"];
    }
}
